{
  description = "origionally the Flake of LibrePhoenix edited a bit by a silly raven";
  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      userSettings = rec {
        ...
        name = "Raven"; # name/identifier
        email = "lavenderraven@duck.com"; # email (used for certain configurations)
        tor-contact = "voidadjacent@proton.me";
        dotfilesDir = "/home/raven/.dotfiles"; # absolute path of the local repo
