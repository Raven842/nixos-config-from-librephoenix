...

{
  ...
  imports = [
              (./. + "../../../user/wm"+("/"+userSettings.wm+"/"+userSettings.wm)+".nix") # Librepheonix's window manager selected from flake
              ../../user/shell/sh.nix # Librepheonix's zsh and bash config
              ../../user/shell/cli-collection.nix # Useful CLI apps
              ../../user/app/doom-emacs/doom.nix # Librephoenix's doom emacs config
              ../../user/app/ranger/ranger.nix # Librepheonix's ranger file manager config
              ../../user/app/git/git.nix # Librepheonix's git config
              ../../user/app/keepass/keepass.nix # Librepheonix's password manager
              (./. + "../../../user/app/browser"+("/"+userSettings.browser)+".nix") # Librepheonix's default browser selected from flake
              ../../user/app/virtualization/virtualization.nix # Virtual machines
              ../../user/app/flatpak/flatpak.nix # Flatpaks
              ../../user/style/stylix.nix # Styling and themes for Librepheonix's apps
